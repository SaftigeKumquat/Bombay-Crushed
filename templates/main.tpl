<div id="contentcontainer" class="container">
	<div class="row">
		<div class="twocol nobox">
			...
			<ul id="personal-menu">
				<li class="unavailable" id="personal-menu-new"><a href="#"><span>+</span><%= texts.createtopic %></a></li>
		...
		<div id="inicontent" class="tencol box last">
			<h2><%= texts.currentinis %></h2>
				<label class="table-label unavailable" for="select_fiter"><%= texts.filter %>:</label>	
