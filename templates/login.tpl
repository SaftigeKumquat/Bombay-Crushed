	...
	<div class="row">
		...
		<div class="eightcol box">
			...
			<div class="box-footer box-editorial">
				...
				<p></p>
				<p>Einen API-Key bekommst du, in dem du dich in <a href="<%= hostsystem %>">Liquid Feedback</a> einloggst und dann rechts oben auf deinen Namen › Einstellungen › Einstellungen für Entwickler klickst.</p>
