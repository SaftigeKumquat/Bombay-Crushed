	...
	<div class="row">		
		<div class="twelvecol last">
			<ul id="mainmenu">
				...
				<li><a <% if(meta.currentpage == "topics") { %>class="active" <% } %>href="topics"><%= texts.topics %></a></li>
				<li><a <% if(meta.currentpage == "contacts") { %>class="active" <% } %>href="contacts"><%= texts.contacts %></a></li>
				<li><a <% if(meta.currentpage == "profile") { %>class="active" <% } %>href="profile"><%= texts.profile %></a></li>
				<li><a <% if(meta.currentpage == "timeline") { %>class="active" <% } %>href="timeline"><%= texts.timeline %></a></li>
			</ul>
